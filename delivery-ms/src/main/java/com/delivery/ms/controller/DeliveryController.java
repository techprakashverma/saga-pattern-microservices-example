...
import com.delivery.ms.dto.NotificationEvent;
...
public class DeliveryController {
	...
	public void deliverOrder(String event) throws JsonMappingException, JsonProcessingException {
		...
		try {
			...
			notificationEvent.setType("STOCK_UPDATED");
			notificationEvent.setOrder(inventoryEvent.getOrder());
			kafkaNotificationTemplate.send("new-notification", notificationEvent);
